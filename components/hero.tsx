      ...
      <div className="mx-auto max-w-[1160px] text-center">
        ...
        */}
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          <Link
            href="/contact"
            className="rounded-pill bg-yellow px-8 py-4 text-[15px] font-semibold text-ink transition-colors hover:bg-yellow-strong"
          >
            Get a Free Consultation
          </Link>
          <Link
            href="/work"
            className="rounded-pill bg-white px-8 py-4 text-[15px] font-semibold text-ink shadow-[0_1px_2px_rgb(0_0_0/0.04)] transition-colors hover:bg-white/70"
          >
            View Our Work
          </Link>
        </div>
